...
namespace TXSoftware.DataObjectsNetEntityModel.Common.UIEditors.Components
{
    public class TreeViewEx : TreeView
    {
        ...
        private bool autoChangeToIndeterminateState = true;
        ...
        public bool TriStateCheckBoxesEnabled
        {
            get
            {
            ...
            {
                // Only if changed.
                if (TriStateCheckBoxesEnabled != value)
                {
                    if (value)
                    {
                        CheckBoxes = false;
        ...
        public new bool CheckBoxes
        {
            ...
            set
            {
                if (value != CheckBoxes)
                {
                    TriStateCheckBoxesEnabled = false;
        ...
        public bool AutoChangeToIndeterminateState
        {
            get { return autoChangeToIndeterminateState; }
            set { autoChangeToIndeterminateState = value; }
        }
        ...
        #endregion enum NodesCheckState
        ...
        internal void DeepSetCheckState(TreeNodeCollection nodes, CheckState checkState)
        {
            foreach (TreeNode node in nodes)
            {
                ...
                {
                    DeepSetCheckState(node.Nodes, checkState);
                }
            }
        }
        ...
        /// <param name="node">The node.</param>
        /// <param name="checkState">State of the check.</param>
        private void DeepSetCheckState(TreeNode node, CheckState checkState)
        {
            InternalSetNodeCheckState(node, checkState);
