...
namespace TXSoftware.DataObjectsNetEntityModel.Dsl
{
	...
	/// </remarks>
	public partial class DONetEntityModelDesignerToolboxHelper : DONetEntityModelDesignerToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerToolboxHelper.
		/// </summary>
		public DONetEntityModelDesignerToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class DONetEntityModelDesignerToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify DONetEntityModelDesigner toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "DONetEntityModelDesigner.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify Inheritance connector tool.
		/// </summary>
		public const string InheritanceFilterString = "Inheritance.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerToolboxHelperBase.
		/// </summary>
		protected DONetEntityModelDesignerToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel.SingletonResourceManager.GetString("DataObjects.Net Entity Model DesignerToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "TXSoftware.DataObjectsNetEntityModel.Dsl.EntityToolboxItem":
					// Add Entity shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"TXSoftware.DataObjectsNetEntityModel.Dsl.EntityToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"TXSoftware.DataObjectsNetEntityModel.Dsl.DataObjects.Net Entity Model DesignerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DataObjects.Net Entity Model DesignerToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::TXSoftware.DataObjectsNetEntityModel.Dsl.Entity.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "TXSoftware.DataObjectsNetEntityModel.Dsl.StructureToolboxItem":
					// Add Structure shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"TXSoftware.DataObjectsNetEntityModel.Dsl.StructureToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("StructureToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("StructureToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"TXSoftware.DataObjectsNetEntityModel.Dsl.DataObjects.Net Entity Model DesignerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DataObjects.Net Entity Model DesignerToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"Structure", // F1 help keyword for the toolbox item.
						resourceManager.GetString("StructureToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::TXSoftware.DataObjectsNetEntityModel.Dsl.Structure.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "TXSoftware.DataObjectsNetEntityModel.Dsl.InheritanceToolboxItem":

					// Add Inheritance connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"TXSoftware.DataObjectsNetEntityModel.Dsl.InheritanceToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "TXSoftware.DataObjectsNetEntityModel.Dsl.InterfaceToolboxItem":
					// Add Interface shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"TXSoftware.DataObjectsNetEntityModel.Dsl.InterfaceToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						4, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("InterfaceToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("InterfaceToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"TXSoftware.DataObjectsNetEntityModel.Dsl.DataObjects.Net Entity Model DesignerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DataObjects.Net Entity Model DesignerToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"Interface", // F1 help keyword for the toolbox item.
						resourceManager.GetString("InterfaceToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::TXSoftware.DataObjectsNetEntityModel.Dsl.Interface.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "TXSoftware.DataObjectsNetEntityModel.Dsl.AssociationToolboxItem":

					// Add Association connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"TXSoftware.DataObjectsNetEntityModel.Dsl.AssociationToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "TXSoftware.DataObjectsNetEntityModel.Dsl.TypedEntitySetToolboxItem":
					// Add TypedEntitySet shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"TXSoftware.DataObjectsNetEntityModel.Dsl.TypedEntitySetToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						6, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("TypedEntitySetToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("TypedEntitySetToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"TXSoftware.DataObjectsNetEntityModel.Dsl.DataObjects.Net Entity Model DesignerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DataObjects.Net Entity Model DesignerToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"", // F1 help keyword for the toolbox item.
						resourceManager.GetString("TypedEntitySetToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::TXSoftware.DataObjectsNetEntityModel.Dsl.TypedEntitySet.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel));
