...
namespace TXSoftware.DataObjectsNetEntityModel.Dsl
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides DONetEntityModelDesigner files
	/// The implementation is done in DONetEntityModelDesignerDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class DONetEntityModelDesignerDirectiveProcessor : DONetEntityModelDesignerDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public DONetEntityModelDesignerDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides DONetEntityModelDesigner files
	/// </summary>
	public class DONetEntityModelDesignerDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string DONetEntityModelDesignerDirectiveProcessorName = "DONetEntityModelDesignerDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "EntityModel";
		...
		/// </summary>
		private const string supportedDirectiveName = "DONetEntityModelDesigner";
		...
		/// Constructor
		/// </summary>
		public DONetEntityModelDesignerDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return DONetEntityModelDesignerDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityModel));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityModel));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "EntityModel" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("DONetEntityModelDesignerDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("TXSoftware.DataObjectsNetEntityModel.Dsl");
