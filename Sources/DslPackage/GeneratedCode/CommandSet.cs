...
namespace TXSoftware.DataObjectsNetEntityModel.Dsl
{
	...
	/// </summary>
	internal partial class DONetEntityModelDesignerCommandSet : DONetEntityModelDesignerCommandSetBase
	{
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerCommandSet.
		/// </summary>
		public DONetEntityModelDesignerCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DONetEntityModelDesignerCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerCommandSetBase.
		/// </summary>
		protected DONetEntityModelDesignerCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDONetEntityModelDesignerExplorerCommand,
				typeof(DONetEntityModelDesignerEditorFactory).GUID);
		...
		{
			DONetEntityModelDesignerExplorerToolWindow explorer = this.DONetEntityModelDesignerExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentDONetEntityModelDesignerDocData != null && this.CurrentDONetEntityModelDesignerDocData.Store != null)
			{
				this.CurrentDONetEntityModelDesignerDocData.ValidationController.Validate(this.CurrentDONetEntityModelDesignerDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentDONetEntityModelDesignerDocData != null && this.CurrentDONetEntityModelDesignerDocData.Store != null)
			{
				...
				this.CurrentDONetEntityModelDesignerDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected DONetEntityModelDesignerDocData CurrentDONetEntityModelDesignerDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DONetEntityModelDesignerDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DONetEntityModelDesignerDocView CurrentDONetEntityModelDesignerDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DONetEntityModelDesignerDocView;
			}
		}
		...
		/// </summary>
		protected DONetEntityModelDesignerExplorerToolWindow DONetEntityModelDesignerExplorerToolWindow
		{
			get
			{
				DONetEntityModelDesignerExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DONetEntityModelDesignerExplorerToolWindow), true) as DONetEntityModelDesignerExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DONetEntityModelDesignerExplorerToolWindow explorerWindow = this.DONetEntityModelDesignerExplorerToolWindow;
