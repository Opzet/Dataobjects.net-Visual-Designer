...
{
    internal partial class DomainTypeSerializer
    {
...
//            }
        ...
        private void CustomRead(SerializationContext serializationContext, ModelElement element, global::System.Xml.XmlReader reader)
        {
            DefaultRead(serializationContext, element, reader);
        }

        private void CustomWriteMoniker(SerializationContext serializationContext, ModelElement element, global::System.Xml.XmlWriter writer, ModelElement sourceRolePlayer, DomainRelationshipXmlSerializer relSerializer)
        {
