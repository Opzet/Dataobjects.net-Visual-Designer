...
namespace TXSoftware.DataObjectsNetEntityModel.Dsl
{
	...
	/// </summary>
	internal partial class DONetEntityModelDesignerDocData : DONetEntityModelDesignerDocDataBase
	{
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerDocData.
		/// </summary>
		public DONetEntityModelDesignerDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a DONetEntityModelDesigner document in memory.
	/// </summary>
	internal abstract partial class DONetEntityModelDesignerDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerDocDataBase.
		/// </summary>
		protected DONetEntityModelDesignerDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(DONetEntityModelDesignerExplorerToolWindow));
		}
		/// <summary>
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityModel modelRoot = null;
			...
			global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityModel modelRoot = this.RootElement as global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityModel;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityDiagram diagram = diagrams[0] as global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityDiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityModel modelRoot = (global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityModel)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
