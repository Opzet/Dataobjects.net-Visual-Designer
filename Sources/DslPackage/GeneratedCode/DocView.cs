...
namespace TXSoftware.DataObjectsNetEntityModel.Dsl
{
	...
	/// </summary>
	internal partial class DONetEntityModelDesignerDocView : DONetEntityModelDesignerDocViewBase
	{
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerDocView.
		/// </summary>
		public DONetEntityModelDesignerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DONetEntityModelDesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerDocView.
		/// </summary>
		protected DONetEntityModelDesignerDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DONetEntityModelDesignerDocDataBase docData = this.DocData as DONetEntityModelDesignerDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DONetEntityModelDesignerDocViewBase should be an DONetEntityModelDesignerDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::TXSoftware.DataObjectsNetEntityModel.Dsl.EntityDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DONetEntityModelDesignerDiagramMenu;
			}
		}
			...
			if(global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::TXSoftware.DataObjectsNetEntityModel.Dsl.DONetEntityModelDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
