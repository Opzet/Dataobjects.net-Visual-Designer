...
using Xtensive.Core;
using Xtensive.Orm;
namespace Model.Version1_0_5_0
{
    [System.SerializableAttribute]
    internal partial class Address: Xtensive.Orm.Structure
    {
        ...
        [Xtensive.Orm.Key]
        internal virtual sbyte SByteField
        {
            get;
            private set;
        }
        ...
        [Xtensive.Orm.Field]
        [Xtensive.Orm.Key]
        public virtual System.TimeSpan TimeSpanField
        {
            get;
            private set;
        }
