...
namespace TXSoftware.DataObjectsNetEntityModel.Dsl
{
	...
	/// </remarks>
	public partial class DONetEntityModelDesignerHelpKeywordHelper : DONetEntityModelDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerHelpKeywordHelper.
		/// </summary>
		protected DONetEntityModelDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DONetEntityModelDesignerHelpKeywordHelper.
		/// </summary>
		public static DONetEntityModelDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DONetEntityModelDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DONetEntityModelDesignerHelpKeywordHelperBase.
		/// </summary>
		protected DONetEntityModelDesignerHelpKeywordHelperBase()
			: base() { }
